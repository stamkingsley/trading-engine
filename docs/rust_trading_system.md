...
## src/serialization/flatbuf_codec.rs
...
impl FlatBufCodec {
    ...
    pub fn serialize(&self, event: &TradeEvent) -> Result<Vec<u8>, SerializationError> {
        ...
        let event_type = match event.event_type {
            EventType::OrderPlaced => TradeEvents::EventType::OrderPlaced,
            EventType::OrderCancelled => TradeEvents::EventType::OrderCancelled,
            EventType::OrderFilled => TradeEvents::EventType::OrderFilled,
            EventType::TradeExecuted => TradeEvents::EventType::TradeExecuted,
            EventType::PriceUpdate => TradeEvents::EventType::PriceUpdate,
        };

        let side = match event.side {
            OrderSide::Buy => TradeEvents::OrderSide::Buy,
            OrderSide::Sell => TradeEvents::OrderSide::Sell,
        };

        // 创建TradeEvent
        let trade_event = TradeEvents::TradeEvent::create(&mut builder, &TradeEvents::TradeEventArgs {
    ...
    pub fn deserialize(&self, data: &[u8]) -> Result<TradeEvent, SerializationError> {
        let trade_event = TradeEvents::root_as_trade_event(data)
        ...
        let event_type = match trade_event.event_type() {
            TradeEvents::EventType::OrderPlaced => EventType::OrderPlaced,
            TradeEvents::EventType::OrderCancelled => EventType::OrderCancelled,
            TradeEvents::EventType::OrderFilled => EventType::OrderFilled,
            TradeEvents::EventType::TradeExecuted => EventType::TradeExecuted,
            TradeEvents::EventType::PriceUpdate => EventType::PriceUpdate,
        };

        let side = match trade_event.side() {
            TradeEvents::OrderSide::Buy => OrderSide::Buy,
            TradeEvents::OrderSide::Sell => OrderSide::Sell,
        };
